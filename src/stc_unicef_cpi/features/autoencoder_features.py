...
def get_trained_autoencoder(
    ...
    :type epochs: int, optional
    :param learning_rate: learning_rate for Adam optimizer, defaults to 0.001
    :type learning_rate: float, optional
    :param save_dir: directory to save model in, defaults to None
    :type save_dir: _type_, optional
    :param model_name: name of saved h5 model file, defaults to None
