...
def download_econ_data():
    ...
    download_file(health_url, f"{c.base_dir_data}/econ/nga_health.csv")
    ...
    out_education = f"{c.base_dir_data}/econ/nga_education.zip"
